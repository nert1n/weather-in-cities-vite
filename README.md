<p align="center">
  <img alt="WISICO logo" width="300px" src="./public/favicon.ico">
</p>

<h1 align="center">WISICO - Frontend Web Application</h1>
...
<p align="center">
  <strong>Live demo:</strong> <a target="_blank" href="https://weather-in-cities-vite.vercel.app/">Visit Template</a>
</p>

<p align="center">
  <strong>Design files:</strong> <a target="_blank" href="https://www.figma.com/design/tnCVBolOWMCGmtS0eaiEyA/%22Weather-in-city%22---web-disign?node-id=102-3&t=O5RbJFPwVEJCr5es-1">Figma</a>
</p>
...
```bash
git clone https://github.com/nert1n/weather-in-cities-vite
cd weather-in-cities-vite
pnpm install
```
